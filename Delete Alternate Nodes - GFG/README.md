...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Singly Linked List of size <strong>N</strong>,&nbsp;delete all alternate nodes of the list.</span></p>
